...
from src.coleta.coletar_barragem_ituporanga import coletar_dados, BARRAGEM_ID

FONTE = "Defesa Civil Ituporanga (nivel-rio)"
...
def salvar_dados():
    ...
    print(f"Processo finalizado (Barragem Sul / Ituporanga). Registros inseridos/atualizados: {inseridos}")
